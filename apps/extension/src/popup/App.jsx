...
export default function PopupApp() {
  ...
  if (loading || !settings) {
    return (
      <main className="flex min-h-[500px] w-[360px] items-center justify-center bg-slate-950 text-slate-300">
        ...
        <section className="p-4">
          <div className="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-md border border-rose-500/40 px-2 py-1 text-[10px] font-semibold text-rose-300"
            >
              Limpiar
            </button>
          </div>
      ...
      {activeTab === "quick" && (
        <section className="grid grid-cols-2 gap-2 p-4">
          <button
            ...
            className="esc-card p-4 text-left hover:border-sky-500/40"
          >
        ...
        <section className="space-y-4 p-4">
          ...
          <article className="esc-card p-3">
            ...
            <button
              ...
              className="mt-3 w-full rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 px-3 py-2 text-xs font-bold uppercase tracking-wide text-white"
            >
